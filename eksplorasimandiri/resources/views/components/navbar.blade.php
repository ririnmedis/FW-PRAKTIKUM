        ...
        <div class="flex items-center">
          ...
          <div class="hidden md:block">
            <div class="ml-10 flex items-baseline space-x-4">
              ...
              <a href="/blog" class="{{ request()->is('/blog')? ' bg-gray-900 px-3 py-2 text-sm font-medium text-white': 'hover:bg-gray-700 hover:text-white'}}
              rounded-md px-3 py-2 text-sm font-medium">Blog</a>
            ...
            <div class="relative ml-3">
              <div>
                ...
                class="relative flex max-w-xs items-center rounded-full bg-gray-800 text-sm focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-800" id="user-menu-button" aria-expanded="false" aria-haspopup="true">
                  ...
                  <img class="h-8 w-8 rounded-full" src="img/ririnmedis.jpg" alt="">
                </button>
              </div>
    ...
    <div  x-show="isOpen" class="md:hidden" id="mobile-menu">
      ...
      <div class="border-t border-gray-700 pb-3 pt-4">
        <div class="flex items-center px-5">
          <div class="flex-shrink-0">
            <img class="h-10 w-9 rounded-full" src="img/ririnmedis.jpg" alt="">
          </div>
          <div class="ml-3">
            <div class="text-base font-medium leading-none text-white">Ririn Medistarani</div>
            <div class="text-sm font-medium leading-none text-gray-400">rmedistarani@gmail.com</div>
          </div>
